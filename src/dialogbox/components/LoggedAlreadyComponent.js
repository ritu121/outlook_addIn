...
const LoggedAlreadyComponent = ({ onClose }) => (
  <div className="flex h-[calc(100vh-104px)] flex-col justify-center items-center  pl-10 pr-10 pb-6">
    <div className="pt-6 pb-8 px-6 rounded-2xl shadow-xl z-20 border border-gray-200 bg-gray-50">
      <div className="flex justify-center text-slt-blue mb-6">
        <svg
      ...
      <div className="bg-blue-100 rounded-lg p-3 mb-6 ">
        <div className="font-medium">Item Logged already!</div>
        <div>Email submitted to Selltis already.</div>
      </div>
...
export default LoggedAlreadyComponent;
